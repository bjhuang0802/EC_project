...
def load_Purchase(flag):
    ...
    if flag == 'predict':
        data=pd.read_csv('/Users/abel/ML_ec/2501/rawdata020/user_url_train.csv')
    else:
        data=pd.read_csv('/Users/abel/ML_ec/2501/rawdata020/user_url_train.csv')
...
def load_ADpredict():
    urlmap=pd.read_csv("/Users/abel/ML_ec/2501/rawdata020/urltable.csv")
    data=pd.read_csv('/Users/abel/ML_ec/2501/rawdata020/user_url.csv',dtype={'campaign':str})
